...
def msg():
    messagebox.showinfo("LKAJSLKAJDS",message="aksjdalksd")

formulario=Tk()

formulario.geometry("600x600")
formulario.title("KLADSJAKLSDJKLASJDAD")
img=PhotoImage("back.png")
bt = Button(formulario,image=img,command=msg,height=40,width=100).place(x=100,y=100)
